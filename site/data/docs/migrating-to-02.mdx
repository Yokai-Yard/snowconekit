...
```bash
npm i @sirbenchalot757/snowconekit@^0.2.0 wagmi@^0.4.2
```
...
```diff
- import { configureChains } from '@sirbenchalot757/snowconekit';
...
```diff
- import { apiProvider } from '@sirbenchalot757/snowconekit';
```
