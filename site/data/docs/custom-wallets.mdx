...
> Note: This API is unstable and likely to change in the near future. We will be adding more built-in wallets over time. [Let us know](https://github.com/sirbenchalot757/snowconekit/issues) if there are any particular wallets you're interested in.
...
<PropsTable
  data={[
    ...
    },
    {
      ...
      required: true,
      type: '(connectorArgs: { chainId? number }) => SnowConeKitConnector',
...
### SnowConeKitConnector properties
...
import { Chain, Wallet } from '@sirbenchalot757/snowconekit';
