...
You can tweak the SnowConeKit UI to match your branding. You can pick from a few pre-defined accent colors and border radius configurations.
...
```tsx
import { SnowConeKitProvider, darkTheme } from '@snowcone/snowconekit';
...
```tsx
import { SnowConeKitProvider, lightTheme } from '@snowcone/snowconekit';
